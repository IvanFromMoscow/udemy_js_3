...
/* harmony import */ var _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/slider_main */ "./src/js/modules/slider/slider_main.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_6__["default"]({
    btns: '.next',
    container: '.page',
    block: '.modules .hanson'
  });
  slider.render();
  var modulePageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_6__["default"]({
    btns: '.next',
    container: '.moduleapp'
  });
    ...
    value: function bindTriggers(container, items, counter) {
      ...
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          items[_this.oldCounter].style.display = 'flex';
          counter++;
        } else {
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      document.body.appendChild(elem); // elem.addEventListener('click', (e) => {
      //     e.stopPropagation();
      //     e.preventDefault();
      // })
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blockedElem = _this.activeBtn.closest('.module__video-item').nextElementSibling;
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      block = _ref$block === void 0 ? null : _ref$block,
...
function (_Slider) {
  ...
  function MainSlider(btns, block) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, block));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      if (this.block) {
        if (n == 3) {
          ...
          setTimeout(function () {
            _this.block.style.opacity = '1';

            _this.block.classList.add('slideInUp');
          }, 3000);
        } else {
          this.block.style.opacity = '0';
    ...
    value: function bindTriggers() {
      ...
      document.querySelectorAll('a.prevmodule').forEach(function (item) {
      ...
      document.querySelectorAll('a.nextmodule').forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
